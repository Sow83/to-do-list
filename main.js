...
function time() {
    ...
    dateElt.textContent = `${days[day]} ${date} / ${month} / ${year}`;
...
function checkTime(i) {
    if (i<10){i = "0" + i}  // ajoute un zéro devant les minutes si elles sont inférieures à 10
    return i;
}

//Active et désacticve le bouton ajouter(btnAddTask)
